...
export default function ProductList({ category }) { // Accept category as a prop
    ...
    const filteredProducts = allProducts.length > 0 && category ? 
        allProducts.filter(product => product.category === category) : allProducts; // Ensure category matches

    console.log("Category prop:", category); // Debugging line
